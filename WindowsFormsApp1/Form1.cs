    ...
    public partial class Form1 : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < points.Length; i++)
                points[i] = rnd.Next(30) % 2 == 0 ? new Point() : new Point3D();
        ...
        private void btnSerialze_Click(object sender, EventArgs e)
        {
        ...
        private void btnDeserialse_Click(object sender, EventArgs e)
        {
